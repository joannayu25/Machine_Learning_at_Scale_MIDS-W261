...
print('Train - untrans')
print(finalTrainDF.count())
print(finalTrainDF.show(5))
print('Validation-untrans')
print(finalValidationDF.count())
print(finalValidationDF.show(5))
...
print(finalTrainDF_trans.show(5))
print('Validation')
print(finalValidationDF_trans.count())
print(finalValidationDF_trans.show(5))
...
model = "Model #4, Gradient Boosted Tree"
data_size = "Full"
depth = 8
time0 = time.time()

# Train and test a Gradient Boosted Tree Classifier to make predicitions
gbtClassifier = GBTClassifier(featuresCol = 'features', labelCol = 'Label', maxDepth = depth)
print("model is fine")
gbtModel = gbtClassifier.fit(finalTrainDF_trans)
print("fit is fine")
predictions = gbtModel.transform(finalValidationDF_trans)
print("prediction is fine!")
